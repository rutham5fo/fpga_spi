...
HD_PWD='C:/Users/91988/Documents/Amruth/Files/EAS/hls_accel/decoder_board/decoder_board.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_sys_wrapper.tcl -notrace
