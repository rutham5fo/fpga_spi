...
HD_PWD='C:/Users/91988/Documents/Amruth/Files/EAS/hls_accel/decoder_board/decoder_board.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_sys_wrapper.tcl
