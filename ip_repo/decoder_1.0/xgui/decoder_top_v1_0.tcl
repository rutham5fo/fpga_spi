...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ERROR_COUNT_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "MAX_ERROR_COUNT" -parent ${Page_0}
  ipgui::add_param $IPINST -name "NUM_REGS_PER_BANK" -parent ${Page_0}
  ipgui::add_param $IPINST -name "REG_BANK_ADDR_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SPI_ADDR_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.SPI_ADDR_WIDTH { PARAM_VALUE.SPI_ADDR_WIDTH } {
	# Procedure called to update SPI_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SPI_ADDR_WIDTH { PARAM_VALUE.SPI_ADDR_WIDTH } {
	# Procedure called to validate SPI_ADDR_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.SPI_ADDR_WIDTH { MODELPARAM_VALUE.SPI_ADDR_WIDTH PARAM_VALUE.SPI_ADDR_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SPI_ADDR_WIDTH}] ${MODELPARAM_VALUE.SPI_ADDR_WIDTH}
}
