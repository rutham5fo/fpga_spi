...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "SPI_PING_PONG_SIZE"
  ipgui::add_param $IPINST -name "SPI_SAMPLER_SIZE"
...
proc update_PARAM_VALUE.SPI_PING_PONG_SIZE { PARAM_VALUE.SPI_PING_PONG_SIZE } {
	# Procedure called to update SPI_PING_PONG_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SPI_PING_PONG_SIZE { PARAM_VALUE.SPI_PING_PONG_SIZE } {
	# Procedure called to validate SPI_PING_PONG_SIZE
	return true
}
...
proc update_PARAM_VALUE.SPI_SAMPLER_SIZE { PARAM_VALUE.SPI_SAMPLER_SIZE } {
	# Procedure called to update SPI_SAMPLER_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SPI_SAMPLER_SIZE { PARAM_VALUE.SPI_SAMPLER_SIZE } {
	# Procedure called to validate SPI_SAMPLER_SIZE
	return true
}
...
proc update_MODELPARAM_VALUE.SPI_PING_PONG_SIZE { MODELPARAM_VALUE.SPI_PING_PONG_SIZE PARAM_VALUE.SPI_PING_PONG_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SPI_PING_PONG_SIZE}] ${MODELPARAM_VALUE.SPI_PING_PONG_SIZE}
}

proc update_MODELPARAM_VALUE.SPI_SAMPLER_SIZE { MODELPARAM_VALUE.SPI_SAMPLER_SIZE PARAM_VALUE.SPI_SAMPLER_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SPI_SAMPLER_SIZE}] ${MODELPARAM_VALUE.SPI_SAMPLER_SIZE}
}
