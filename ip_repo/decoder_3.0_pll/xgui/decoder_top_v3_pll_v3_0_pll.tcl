...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "LEDS_REG_NUM"
  ipgui::add_param $IPINST -name "COMMS_DEBUG"
  ipgui::add_param $IPINST -name "SHIFT_IN_COMP"
  ipgui::add_param $IPINST -name "SHIFT_OUT_COMP"
  ipgui::add_param $IPINST -name "ERROR_COUNT_WIDTH"
  ipgui::add_param $IPINST -name "REG_BANK_ADDR_WIDTH"

}

proc update_PARAM_VALUE.COMMS_DEBUG { PARAM_VALUE.COMMS_DEBUG } {
	# Procedure called to update COMMS_DEBUG when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.COMMS_DEBUG { PARAM_VALUE.COMMS_DEBUG } {
	# Procedure called to validate COMMS_DEBUG
	return true
}
...
proc update_PARAM_VALUE.LEDS_REG_NUM { PARAM_VALUE.LEDS_REG_NUM } {
	# Procedure called to update LEDS_REG_NUM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.LEDS_REG_NUM { PARAM_VALUE.LEDS_REG_NUM } {
	# Procedure called to validate LEDS_REG_NUM
	return true
}
...
proc update_PARAM_VALUE.SHIFT_IN_COMP { PARAM_VALUE.SHIFT_IN_COMP } {
	# Procedure called to update SHIFT_IN_COMP when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SHIFT_IN_COMP { PARAM_VALUE.SHIFT_IN_COMP } {
	# Procedure called to validate SHIFT_IN_COMP
	return true
}

proc update_PARAM_VALUE.SHIFT_OUT_COMP { PARAM_VALUE.SHIFT_OUT_COMP } {
	# Procedure called to update SHIFT_OUT_COMP when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SHIFT_OUT_COMP { PARAM_VALUE.SHIFT_OUT_COMP } {
	# Procedure called to validate SHIFT_OUT_COMP
	return true
}
...
proc update_MODELPARAM_VALUE.LEDS_REG_NUM { MODELPARAM_VALUE.LEDS_REG_NUM PARAM_VALUE.LEDS_REG_NUM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.LEDS_REG_NUM}] ${MODELPARAM_VALUE.LEDS_REG_NUM}
}

proc update_MODELPARAM_VALUE.COMMS_DEBUG { MODELPARAM_VALUE.COMMS_DEBUG PARAM_VALUE.COMMS_DEBUG } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.COMMS_DEBUG}] ${MODELPARAM_VALUE.COMMS_DEBUG}
}

proc update_MODELPARAM_VALUE.SHIFT_IN_COMP { MODELPARAM_VALUE.SHIFT_IN_COMP PARAM_VALUE.SHIFT_IN_COMP } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SHIFT_IN_COMP}] ${MODELPARAM_VALUE.SHIFT_IN_COMP}
}

proc update_MODELPARAM_VALUE.SHIFT_OUT_COMP { MODELPARAM_VALUE.SHIFT_OUT_COMP PARAM_VALUE.SHIFT_OUT_COMP } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SHIFT_OUT_COMP}] ${MODELPARAM_VALUE.SHIFT_OUT_COMP}
}
