...
#set dec_spi_clk_in [get_clocks -of [get_ports dec_spi_clk]]
set dec_spi_clk_in [get_clocks -of [get_pins -of [get_cells -hier * -filter {name =~ "*decoder_top*/inst*"}] -filter {ref_pin_name == "spi_clk_pll_0"}]]
...
set_clock_groups -async -group [list "$dec_spi_clk_in" [get_clocks dec_spiClk_out]] -group "$dec_sys_clk"
...
set_max_delay -datapath_only -from [get_pins -of [get_cells -hier spi_clk_en_reg_reg -filter {name =~ "*axi_spi_interface*/inst*"}] -filter {ref_pin_name == C}] -to [get_pins -of [get_cells -hier spi_clk_pll_0_bufgce -filter {name =~ "*decoder_top*/inst*"}] -filter {ref_pin_name == CE0}] 3
set_min_delay -from [get_pins -of [get_cells -hier spi_clk_en_reg_reg -filter {name =~ "*axi_spi_interface*/inst*"}] -filter {ref_pin_name == C}] -to [get_pins -of [get_cells -hier spi_clk_pll_0_bufgce -filter {name =~ "*decoder_top*/inst*"}] -filter {ref_pin_name == CE0}] 0

set_max_delay -datapath_only -from [get_pins -of [get_cells -hier spi_clk_en_reg_reg -filter {name =~ "*axi_spi_interface*/inst*"}] -filter {ref_pin_name == C}] -to [get_pins -of [get_cells -hier spi_clk_pll_180_bufgce -filter {name =~ "*decoder_top*/inst*"}] -filter {ref_pin_name == CE0}] 3
set_min_delay -from [get_pins -of [get_cells -hier spi_clk_en_reg_reg -filter {name =~ "*axi_spi_interface*/inst*"}] -filter {ref_pin_name == C}] -to [get_pins -of [get_cells -hier spi_clk_pll_180_bufgce -filter {name =~ "*decoder_top*/inst*"}] -filter {ref_pin_name == CE0}] 0
...
set_input_delay -clock "$dec_spi_clk_in" -max [expr "$unit_interval - $enc_dv_half"] [get_ports [list "dec_spi_mosi" "dec_spi_cs_n"]];
set_input_delay -clock "$dec_spi_clk_in" -min "$enc_dv_half" [get_ports [list "dec_spi_mosi" "dec_spi_cs_n"]];
...
set_false_path -from [get_ports dec_reset_n] -to [all_registers -clock "$dec_spi_clk_in"]
