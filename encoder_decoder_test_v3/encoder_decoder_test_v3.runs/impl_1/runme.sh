...
HD_PWD='C:/Users/91988/Documents/Amruth/Files/EAS/hls_accel/encoder_decoder_test_v3/encoder_decoder_test_v3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_test_v3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_test_v3_wrapper.tcl -notrace
