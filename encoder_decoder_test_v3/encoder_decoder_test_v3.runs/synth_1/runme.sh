...
HD_PWD='C:/Users/91988/Documents/Amruth/Files/EAS/hls_accel/encoder_decoder_test_v3/encoder_decoder_test_v3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_test_v3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_test_v3_wrapper.tcl
