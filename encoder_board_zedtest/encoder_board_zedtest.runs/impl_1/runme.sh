...
HD_PWD='C:/Users/91988/Documents/Amruth/Files/EAS/hls_accel/encoder_board_zedtest/encoder_board_zedtest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_system_wrapper.tcl -notrace
