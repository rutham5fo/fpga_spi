...
HD_PWD='C:/Users/91988/Documents/Amruth/Files/EAS/hls_accel/encoder_board_zedtest/encoder_board_zedtest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_system_wrapper.tcl
