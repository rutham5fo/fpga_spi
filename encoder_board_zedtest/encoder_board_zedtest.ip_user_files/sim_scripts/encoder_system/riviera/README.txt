...
#
# Generated by export_simulation on Fri Oct 06 08:03:12 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './encoder_system.sh' script.

./encoder_system.sh -reset_run
...
./encoder_system.sh -noclean_files

For more information on the script, please type './encoder_system.sh -help'.
